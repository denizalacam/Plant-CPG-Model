...
lib = ct.cdll.LoadLibrary(os.path.dirname(__file__)+'/lib/_plant_alpha_hcurrent.so')
PI2 = tl.PI2
...
def integrate_n_rk4_phasedifferences_electricExcitatoryAndInhibitoryConnections(networkSize, initial_states,
                                     ...
                                     coupling_strengths_sodium, coupling_strengths_electric,coupling_alpha_syn,
    ...
    print np.reshape(P_out, (numberOfPhaseDifferences[0], networkSize-1), 'C'), ', size : ', numberOfPhaseDifferences[0]
